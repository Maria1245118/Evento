<%-- 
    Document   : sala-cadastrar
    Created on : 27/02/2021, 16:46:24
    Author     : Maria
--%>
...
<jsp:param name="tituloPagina" value="Cadastro de Sala" />
</jsp:include>
                <h1>Cadastro de Sala</h1>
                
                <form action="sala-recebe-cadastrar.jsp" method="POST" onsubmit="return enviarForm()">
                                       
                    <div class="form-grupo">
                        <label>Nome da Sala <span class="asterisco">*</span></label>
        ...
        <script>
            function enviarForm() {
                ...
                if (nome[0].value === "") {
                    document.getElementById("erroNome").innerHTML = "Informar o Nome da Sala";
